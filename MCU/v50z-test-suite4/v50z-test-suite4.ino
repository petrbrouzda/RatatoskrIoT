 ...
 * Testuje spotrebu pameti, pokud vypinam a zapinam WiFi (a neposilam zadna data)
 */
...
void wifiZapni()
{
  ...
  tasker.setTimeout( wifiVypni, 10000 );  
  startWifi();
}
...
void wifiVypni()
{
  ...
  tasker.setTimeout( wifiZapni, 10000 );  
  stopWifi();
}
