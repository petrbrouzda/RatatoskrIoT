 ...
 * Testuje spotrebu pameti, pokud cas od casu poslu nejakou zpravu - a pro kazdou zapnu WiFi a pak ho zase vypnu
 */
...
void setup() {
  ...
  tasker.setInterval( generujAPosliNejakaData, 15000 );
