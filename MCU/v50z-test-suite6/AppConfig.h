...
// ================================= obecna konfigurace
   ...
   * Informace se vypisuji jen pri startu, co neni probuzenim z deep sleep (ESP32); nebo po prijmu pozadavku na zmenu konfigurace ze serveru. */
